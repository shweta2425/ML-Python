...
#         pickle_in = pickle.load(file)
    ...
    def accuracy(self,y,y_pred):
        ...
        median_ab_error = median_absolute_error(y, y_pred)
        return acc_r2, median_ab_error
        
    def plotting(self,x,y,y_pred):
